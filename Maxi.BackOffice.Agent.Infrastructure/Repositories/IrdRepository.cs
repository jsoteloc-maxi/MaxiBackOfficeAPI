...
namespace Maxi.BackOffice.Agent.Infrastructure.Repositories
{
    public class IrdRepository : IIrdRepository
    {
        ...
        /// 
        /// </summary>
        /// <param name="idCheckOri"></param>
        /// <param name="ignoreDeny"></param>
        /// <param name="IsIrdPrinted"></param>
        /// <returns></returns>
        public dynamic ObtenerImagenesIRD(int idCheckOri, bool ignoreDeny = false, bool IsIrdPrinted = true)
        {
            ...
            try
            {
                ...
                _dbContext.GetConnection()
                    .Execute(
                    sqlUpd,
                    new { IrdMicr = rejectInfo.IrdMicr, Id = rejectInfo.IdCheckRejectHistory, IrdPrinted = IsIrdPrinted },
                    _dbContext.GetTransaction());
        ...
        /// <param name="fileFront"></param>
        /// <param name="fileRear"></param>
        /// <exception cref="Exception"></exception>
